...
import CardSetSearchAdvanced from './CardSetSearchAdvanced'
    ...
    return (
      <div className="flex-col-center my-3">
        <form className="flex-col-center" onSubmit={this.clickSearch}>
          <select className="btn drop-search" onChange={this.handleChangeSet}>
          ...
          {adv ? (
            <CardSetSearchAdvanced
              handleChangeSupertype={this.handleChangeSupertype}
